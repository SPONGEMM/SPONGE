...
void QUANTUM_CHEMISTRY::Build_DFT_XC_Gradient()
{
    ...
    // TODO: UKS XC gradient (currently only RKS)
    QC_Build_DFT_XC_Gradient_RKS(
        ...
        dft.d_ao_grad_y_cart, dft.d_ao_grad_z_cart, dft.d_ao_vals,
        dft.d_ao_grad_x, dft.d_ao_grad_y, dft.d_ao_grad_z, dft.d_rho,
        dft.d_sigma, dft.d_exc, dft.d_vrho, dft.d_vsigma, dft.d_ao_norm,
        dft.d_gx_norm, dft.d_gy_norm, dft.d_gz_norm, dft.d_Pao,
        dft.d_grad_rho_x, dft.d_grad_rho_y, dft.d_grad_rho_z,
        dft.d_shell_r2_screen, grad_ws.d_shell_atom, d_ao_off_eff,
        dft.d_W_full, dft.d_W_sigma, grad_ws.d_grad);
}
