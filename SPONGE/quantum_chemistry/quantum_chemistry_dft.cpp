...
void QUANTUM_CHEMISTRY::Build_DFT_VXC()
{
    if (scf_ws.runtime.unrestricted)
    {
        QC_Build_DFT_VXC_UKS(
            ...
            dft.d_shell_r2_screen, dft.d_ao_norm, dft.d_gx_norm,
            dft.d_gy_norm, dft.d_gz_norm, dft.d_Pao, dft.d_W_full,
            dft.d_W_sigma, dft.d_grad_rho_x, dft.d_grad_rho_y,
            dft.d_grad_rho_z, dft.d_Pao_b, dft.d_rho_a, dft.d_rho_b,
            dft.d_sigma_aa, dft.d_sigma_ab, dft.d_sigma_bb, dft.d_grb_x,
            dft.d_grb_y, dft.d_grb_z, dft.d_exc_buf, dft.d_vra, dft.d_vrb,
            dft.d_vsaa, dft.d_vsab, dft.d_vsbb, dft.d_Wb_full,
            dft.d_Wb_sigma);
    }
    else
    {
