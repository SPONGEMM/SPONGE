...
static __device__ __forceinline__ int find_bond_index(
    int atom, int neighbor, const int* bond_count, const int* bond_offset,
    const int* bond_nbr, const int* bond_idx)
{
