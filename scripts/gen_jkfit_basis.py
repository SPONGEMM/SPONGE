...
def build_shells(basis_name, symbol):
    ...
    mol = gto.M(atom=f"{symbol} 0 0 0", basis=basis_name, unit="Angstrom",
                verbose=0, spin=spin)
...
def main():
    ...
    out.append('// Reference: F. Weigend, Phys. Chem. Chem. Phys. 8, 1057 (2006)')
    out.append('')
    ...
    out.append('};')
    out.append('')
    out.append('static QC_BASIS_DEF2_UNIVERSAL_JKFIT _qc_basis_def2_universal_jkfit_instance;')
    out.append('static QC_BASIS_SET* QC_BASIS_DEF2_UNIVERSAL_JKFIT_PTR = &_qc_basis_def2_universal_jkfit_instance;')
    out.append('')
